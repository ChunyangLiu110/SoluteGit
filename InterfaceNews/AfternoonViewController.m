...
@interface AfternoonViewController ()

@end

@implementation AfternoonViewController
...
- (void)loadDataFromNet :(BOOL)isMore {
    ...
    [_manager GET:AFTERNOONURL parameters:dic success:^(AFHTTPRequestOperation *operation, id responseObject) {
